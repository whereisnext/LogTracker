...
public class Aggregation_Min implements MapReduce {
	...
	public Aggregation_Min(DBCollection dbColl) {
		this.dbColl=dbColl;
	}
	...
	public void setReduce() {
		this.reduce="function (key, values) { var min = values[0]; values.forEach(function (val) { if (val < min) min = val; }) " +
				"\n"+
				"return min}";
