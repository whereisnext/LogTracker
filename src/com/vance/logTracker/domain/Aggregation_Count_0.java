...
public class Aggregation_Count_0 implements MapReduce {
	...
	public Aggregation_Count_0(DBCollection dbColl) {
	...
	public Double getMapReduceResult(DBCollection dbColl,String apiName, String serviceName,DBObject query) {
		...
		queryBuilder.greaterThanEquals(0);
		queryBuilder.lessThan(50);
