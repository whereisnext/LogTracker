...
public class Aggregation_Count_2000 implements MapReduce {
	...
	public Aggregation_Count_2000(DBCollection dbColl) {
	...
	public Double getMapReduceResult(DBCollection dbColl,String apiName, String serviceName,DBObject query) {
		...
		queryBuilder.greaterThanEquals(2000);
		queryBuilder.lessThan(3000);
