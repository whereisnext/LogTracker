...
public class Aggregation_Count_500 implements MapReduce {
	...
	public Aggregation_Count_500(DBCollection dbColl) {
	...
	public Double getMapReduceResult(DBCollection dbColl,String apiName, String serviceName,DBObject query) {
		...
		queryBuilder.greaterThanEquals(500);
		queryBuilder.lessThan(1000);
