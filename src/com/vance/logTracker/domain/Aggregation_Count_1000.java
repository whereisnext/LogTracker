...
public class Aggregation_Count_1000 implements MapReduce {
	...
	public Aggregation_Count_1000(DBCollection dbColl) {
	...
	public Double getMapReduceResult(DBCollection dbColl,String apiName, String serviceName,DBObject query) {
		...
		queryBuilder.greaterThanEquals(1000);
		queryBuilder.lessThan(2000);
