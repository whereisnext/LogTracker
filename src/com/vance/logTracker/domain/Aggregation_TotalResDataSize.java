...
public class Aggregation_TotalResDataSize implements MapReduce {
	...
	public Aggregation_TotalResDataSize(DBCollection dbColl) {
		this.dbColl=dbColl;
	}
	...
	@Override
	public void setMap() {
		this.map="function Map(){emit('res',this.dataSize)}";
		
	}

	@Override
	public void setReduce() {
		this.reduce="function(key,values){var res=0;values.forEach(function(val){res+=parseInt(val)});return res}";
