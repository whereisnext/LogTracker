...
public class EPAccessLogPanel extends Panel {
	/**
	 * 
	 */
	...
	public EPAccessLogPanel(final String id,ArrayList lists) {
		super(id);
...
//					response.renderJavaScriptReference("yui-min.js");
					...
					pageResponse
							.write("var myChart=new Y.Chart({dataProvider:myDataValues,"
									...
									+ "horizontalGridlines:true,verticalGridlines:true,render:\"#epChart\"});");
					// pageResponse.write("});");
					pageResponse.write("});})();");
					// pageResponse
...
//					response.renderJavaScriptReference("alert('aaa')");
		...
		ListView<Object> listView= new ListView<Object>("epListView", lists) {
			/**
			 * 
			 */
			...
			protected void populateItem(ListItem item) {
				...
				item.add(new Label("totalHits", cbsAccessLog.getTotalHits()
						.toString()));
				item.add(new Label(
						"ninetyPercentTime",
