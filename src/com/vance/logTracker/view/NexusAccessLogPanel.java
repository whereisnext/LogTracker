...
public class NexusAccessLogPanel extends Panel {
	/**
	 * 
	 */
	...
	public NexusAccessLogPanel(final String id,ArrayList lists) {
		super(id);
		...
		add(new Label("nexusChart","nexusChart"));
				...
				public void renderHead(Component component, IHeaderResponse response) {
					...
					pageResponse
							.write("var myChart=new Y.Chart({dataProvider:myDataValues,"
									...
									+ "horizontalGridlines:true,verticalGridlines:true,render:\"#nexusChart\"});");
					// pageResponse.write("});");
					pageResponse.write("});})();");
					// pageResponse
...
//					response.renderJavaScriptReference("alert('aaa')");
		...
		ListView<Object> listView= new ListView<Object>("nexusListView", lists) {
			/**
			 * 
			 */
			...
			protected void populateItem(ListItem item) {
				...
				AjaxLink apiNameLink = new AjaxLink("url") {
					...
					public void onClick(AjaxRequestTarget target) {
						...
						parameters.set("application", "Nexus");
