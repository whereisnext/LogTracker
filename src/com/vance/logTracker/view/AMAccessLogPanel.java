...
public class AMAccessLogPanel extends Panel {
	/**
	 * 
	 */
	...
	public AMAccessLogPanel(final String id,ArrayList lists) {
		super(id);
				...
				public void renderHead(Component component, IHeaderResponse response) {
					...
					for (int i = 0; i < totalSize; i++) {
						...
						pageResponse.write("{category:'"
								+ getLists().get(i).getUrl().toString()
								+ "', " + "ninetyPercentResp: "
					...
					pageResponse
							.write("var myChart=new Y.Chart({dataProvider:myDataValues,"
									...
									+ "horizontalGridlines:true,verticalGridlines:true,render:\"#amChart\"});");
					// pageResponse.write("});");
					pageResponse.write("});})();");
					// pageResponse
...
//					response.renderJavaScriptReference("alert('aaa')");
		...
		ListView<Object> listView= new ListView<Object>("amListView", lists) {
			/**
			 * 
			 */
