...
public class Aggregation_Max implements MapReduce {
	...
	public Aggregation_Max(DBCollection dbColl) {
		this.dbColl=dbColl;
	}
	...
	public void setReduce() {
		this.reduce="function (key, values) { var max = values[0]; values.forEach(function (val) { if (val > max) max = val; }) " +
				"\n"+
				"return max}";
