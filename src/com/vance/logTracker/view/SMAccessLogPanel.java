...
public class SMAccessLogPanel extends Panel {
	/**
	 * 
	 */
	...
	public SMAccessLogPanel(final String id,ArrayList lists) {
		super(id);
...
//					response.renderJavaScriptReference("yui-min.js");
					...
					pageResponse
							.write("var myChart=new Y.Chart({dataProvider:myDataValues,"
									...
									+ "horizontalGridlines:true,verticalGridlines:true,render:\"#smChart\"});");
					// pageResponse.write("});");
					pageResponse.write("});})();");
					// pageResponse
...
//					response.renderJavaScriptReference("alert('aaa')");
		...
		ListView<Object> listView= new ListView<Object>("smListView", lists) {
			/**
			 * 
			 */
