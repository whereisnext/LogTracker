...
public class Aggregation_Count_200 implements MapReduce {
	...
	public Aggregation_Count_200(DBCollection dbColl) {
	...
	public Double getMapReduceResult(DBCollection dbColl,String apiName, String serviceName,DBObject query) {
		...
		queryBuilder.greaterThanEquals(200);
		queryBuilder.lessThan(500);
