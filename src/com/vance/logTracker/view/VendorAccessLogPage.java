...
public class VendorAccessLogPage extends Panel {
	/**
	 * 
	 */
	...
	public VendorAccessLogPage(final String id,ArrayList lists) {
		super(id);
				...
				public void renderHead(Component component, IHeaderResponse response) {
					...
					pageResponse
							.write("var myChart=new Y.Chart({dataProvider:myDataValues,"
									...
									+ "horizontalGridlines:true,verticalGridlines:true,render:\"#vendorChart\"});");
					// pageResponse.write("});");
					pageResponse.write("});})();");
					// pageResponse
...
//					response.renderJavaScriptReference("alert('aaa')");
		...
		ListView<Object> listView= new ListView<Object>("vendorlistview", lists) {
			/**
			 * 
			 */
