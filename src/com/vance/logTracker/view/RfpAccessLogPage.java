...
public class RfpAccessLogPage extends Panel {
	/**
	 * 
	 */
	...
	public RfpAccessLogPage(final String id,ArrayList lists) {
		super(id);
		this.panelId=id;
		setLists(lists);
		if (lists != null) {
		...
		add(new Label("rfpChart","rfpChart"));
...
//					response.renderJavaScriptReference("yui-min.js");
					...
					pageResponse
							.write("var myChart=new Y.Chart({dataProvider:myDataValues,"
									...
									+ "horizontalGridlines:true,verticalGridlines:true,render:\"#rfpChart\"});");
					// pageResponse.write("});");
					pageResponse.write("});})();");
					// pageResponse
